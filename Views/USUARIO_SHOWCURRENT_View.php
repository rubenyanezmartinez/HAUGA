...
class USUARIO_SHOWCURRENT_View{
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col text-left">
                    <a href="../Controllers/User_Controller.php?action=edit&login_usuario=<?=$this->usuario->getLogin()?>" class="btn btn-warning">
                ...
                <div class="col text-right">
                    ...
                    if($_SESSION['rol'] == 'USUARIO_NORMAL'){
                    ...
                    ?>
                    <a id="botonAtras" href=<?= $ruta ?> class="btn btn-light">
                        Atrás
