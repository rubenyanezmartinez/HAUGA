            ...
            <script>
                $(document).ready(function() {
                    ...
                    $("#botonBorrar").click(function () {
                        alert("Por favor entra qjui");
                        //console.log("entra");
                        //console.log($('#eliminarUsuario').data('enlace'));
                        //$('#username').attr("href", $('#eliminarUsuario').data('enlace'));
                    });
                });
            </script>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="../Controllers/User_Controller.php?action=edit">
                                    ...
                                    <?php echo '<a id="eliminarUsuario" name="eliminarUsuario" data-enlace="../Controllers/User_Controller.php?action=showcurrent&login_usuario='.$this->usuarios[$i]->getLogin().'" data-toggle="modal" data-target="#exampleModal">' ?>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <?php echo '<a id="username" href="../Controllers/User_Controller.php?action=delete&login_usuario='.$this->usuarios[$i]->getLogin().'">' ?>
