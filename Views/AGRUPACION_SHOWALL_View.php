...
class AGRUPACION_SHOWALL_View{
    ...
    function __construct($arrayAgrupaciones, $numEdificios, $num_pag)
    {
            ...
            <div class="row">
                <table class="table table-bordered">
                    ...
                    <tr class="text-center" style="color: white;background-color: #073349;">
                        <th scope="col" width="25%">Nombre de la Agrupación</th>
                    ...
                    foreach($this->arrayAgrupaciones as $agrup){ ?>
                        ...
                        <tr>
                            <th scope="row"><?=$agrup->getNombreAgrup()?></th>
                            <th><?=$agrup->getUbicacionAgrup()?></th>
                            <th style="text-align: center"><?=$this->numEdificios[$agrup->getAgrupId()]?></th>
                            <th style="text-align: center">
                                <a href="../Controllers/AGRUPACION_Controller.php?action=showcurrent&agrup_id=<?=$agrup->getAgrupId()?>">
                                ...
                                <?php if(IsAuthenticated() && esAdministrador()) {?>
                                     <a class="eliminar" data-enlace="<?=$agrup->getAgrupId()?>">
                                ...
                                <a href="../Controllers/Edificio_Controller.php?action=showall&agrupacion_id=<?=$agrup->getAgrupId()?>">
