<?php
class DEPARTAMENTO_SHOWALL_View{

    var $arrayDepartamentos;
    var $numPag;
    var $loginResponsables;

    function __construct($arrayDepartamentos, $loginResponsables , $numPag)
    {
    ...
    function render(){
        ...
        <script>
            $(document).on('click', '.eliminar', function () {
                ...
                var enlace = "../Controllers/Departamento_Controller.php?action=delete&depart_id="+descr;
                console.log(descr)
        ...
        <div class="row align-self-center">
            <div class="col text-left">
                ...
                if(IsAuthenticated() && esAdministrador()){ ?>
                    <a class="btn btn-primary" style="background-color: #073349;" href="../Controllers/Departamento_Controller.php?action=add">
            ...
            <div class="col align-self-center">
                <h2 class="text-center textoAzul">Departamentos</h2>
            </div>
        ...
        <div class="row">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php
                foreach($this->arrayDepartamentos as $depart){ ?>

                    <tr>
                        <th scope="row"><?=$depart->getCodigoDepart()?></th>
                        <th><?=$depart->getNombreDepart()?></th>
                        <th><?=$this->loginResponsables[$depart->getDepartId()]?></th>
                        <th><?=$depart->getEmailDepart()?></th>
                        <th style="text-align: center">
                            <a href="../Controllers/Departamento_Controller.php?action=showcurrent&depart_id=<?=$depart->getDepartId()?>">
                            ...
                            <?php if(IsAuthenticated() && esAdministrador()) {?>
                                <a class="eliminar" data-enlace="<?=$depart->getDepartId()?>">
