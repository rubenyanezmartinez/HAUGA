...
class ESPACIO_SHOWALL_View
{
    ...
    function __construct($arrayEspacios, $nombreEdificios, $nombresResponsables, $num_pag)
    {
            ...
            <div class="row align-self-center">
                <div class="col text-left">
                    ...
                    if(IsAuthenticated() && esAdministrador()){ ?>
                        <a class="btn btn-primary" style="background-color: #073349;" href="#">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">
                                ...
                                <?php if(IsAuthenticated() && esAdministrador()) {?>
                                    ...
                                    <a class="eliminar" data-enlace="<?=$espacio->getEspacioId()?>">
